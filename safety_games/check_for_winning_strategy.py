...
def check_if_always_winning_stratergy( vertices_graph, edges_graph, map_vertex_to_player, bad_states , initial_state, player_index):
	if player_index == 1:
...
def check_if_never_winning_stratergy( vertices_graph, edges_graph, map_vertex_to_player, bad_states , initial_state, player_index):
	for key,value in map_vertex_to_player.items():
